...
1. Fork `the repository <https://github.com/affo/affo-deeplink>`_ and clone the fork.
...
When `reporting a bug <https://github.com/affo/affo-deeplink/issues>`_
please include:

    * Operating system name and version.
    * `affo-deeplink` version.
...
`Github <https://github.com/affo/affo-deeplink/issues>`_. If you are proposing a feature:
